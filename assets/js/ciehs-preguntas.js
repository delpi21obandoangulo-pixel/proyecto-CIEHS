...
(function (global) {
  ...
  global.CIEHS_PREGUNTAS = {
    ...
    primaria: [
      ...
      { id:'primaria-2', cat:'cultivo', q:'¿Qué significan las siglas DWC en el módulo MOD-DWC-01?',
        ops:[['Cultivo en Agua Profunda',true],['Doble William Cultivo',false],['Dosis Warm Control',false]],
        exp:'DWC es Deep Water Culture, raíz flotante: una balsa sobre el depósito y la raíz sumergida en la solución.' },
      ...
      { id:'primaria-7', cat:'agua', q:'En el CIEHS, la solución nutritiva…',
        ops:[['Se queda en el módulo y la planta la va consumiendo',true],['Se tira después de cada riego',false],['Solo se usa una vez al año',false]],
        exp:'Nuestros módulos son no circulantes: no hay bomba ni riego. El ahorro está en que casi nada se evapora ni se filtra al suelo.' },
      { id:'primaria-8', cat:'cultivo', q:'¿Cuántos módulos hidropónicos activos tiene el CIEHS?',
        ops:[['Quince',true],['Uno',false],['Cuatro',false]],
        exp:'Quince, todos de raíz flotante (DWC): MOD-DWC-01 a MOD-DWC-15.' },
      { id:'primaria-9', cat:'ciencia', q:'Si comparo semillas en algodón húmedo y en esponja de almácigo, ¿qué estoy haciendo?',
      ...
      { id:'primaria-21', cat:'cultivo', q:'Los módulos MOD-DWC-12 a 15 aprovechan sobre todo…',
        ops:[['Botellas usadas que iban a la basura',true],['El agua del mar',false],['La lluvia',false]],
        exp:'Son botellas reutilizadas: el mismo envase que acababa en la playa sostiene ahora una cebolla china.' },
    ...
    secundaria: [
      ...
      { id:'secundaria-3', cat:'agua', q:'En los módulos del CIEHS el nivel de solución no se rellena hasta el borde porque…',
        ops:[['La cámara de aire es donde la raíz toma oxígeno',true],['Ahorra electricidad en la bomba',false],['Evita que crezcan las hojas',false]],
        exp:'Al bajar el nivel, la raíz se diferencia en raíces de agua y raíces de aire. Rellenar hasta arriba ahoga estas últimas.' },
      ...
      { id:'secundaria-13', cat:'cultivo', q:'El módulo MOD-DWC-02 se conoce en castellano como…',
        ...
        exp:'Deep Water Culture: una balsa sobre el depósito. En el CIEHS funciona hoy sin bomba de aire, en su versión no circulante.' },
      ...
      { id:'secundaria-15', cat:'agua', q:'La aireación forzada, planificada como mejora del CIEHS, serviría para…',
        ops:[['Mantener oxígeno disuelto disponible para las raíces',true],['Bajar el pH',false],['Calentar la solución',false]],
        exp:'Hoy el oxígeno llega por la cámara de aire y por agitación manual. La bomba es una mejora prevista, no una condición actual.' },
      ...
      { id:'secundaria-23', cat:'cultivo', q:'El soporte de la balsa en raíz flotante se llama inerte porque…',
        ops:[['No aporta nutrientes: solo sostiene la plántula',true],['Está muerto',false],['No deja pasar el agua',false]],
